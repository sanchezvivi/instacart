...
recorr_mean_compra <- 33758

valueBox(value = round(, 1), 
         icon = "fa-carrot",
         color = ic_cols("green"))
...
churn_mean_compra <- 33758

valueBox(round(, 1), icon = "fa-carrot",
         color = ic_cols("orange"))
...
churn_mean_days <- 33758

valueBox(round(, 1), icon = "ion-today-outline",
         color = ic_cols("orange"))
