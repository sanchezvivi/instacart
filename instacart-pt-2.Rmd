...
### Total de  pessoas (MILHÕES)

```{r}

n_pessoas <- 2000000

valueBox(value = prettyNum(n_pessoas, big.mark = " ", format = "f"), 
         icon = "fa-user",
...
valueBox(value = prettyNum(ticket, big.mark = " ", format = "f"), 
...
valueBox(value = prettyNum(potencial, big.mark = " ", format = "f"), 
         icon = "fa-money",
         color = ic_cols("green"))
