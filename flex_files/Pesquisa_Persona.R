...
data_1<- data_1%>% 
  drop_na("As compras de supermercado são feitas por app ou fisicamente?2")

## "As compras de supermercado são feitas por app ou fisicamente?2"
data_1F<- read_data(data_1,"As compras de supermercado são feitas por app ou fisicamente?2",'fisicamente')
data_1APP <- read_data(data_1,"As compras de supermercado são feitas por app ou fisicamente?2",'app')
...
## Compra de supermercado por app

col="Quais apps costuma usar?"
freqAPP <- freq_palavras(data_1APP,col,6)
freqAPP 

## Compra de supermercado fisicamente
